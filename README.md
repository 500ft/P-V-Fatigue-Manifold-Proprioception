...
> Historical PDF integrity is not publication clearance; no corrected PDF or DOI
> is claimed.
...
| **Primary artifact** | Archived v1.3 results plus unreviewed correction candidate |
...
flowchart LR
    ...
    A --> D{{Separate analytic P-V probe / zero rest}}:::core
...
| --- | --- |
| Idealized P-V area as a candidate recalibration signal | pooled `r = 0.885`, actuator-cluster bootstrap `[0.853, 0.950]`; structurally favored within one generator |
| P-V-triggered recalibration vs. always-on | meets train-derived macro-averaged stage-RMSE budget with 2 calibration events vs. 5, including initial calibration |
...
# Explicit deposit gate: expected exit 2 while correction is unreviewed
...
New preprint posting is **blocked by the methods correction and author review**.
The historical release remains unchanged. arXiv submission was awaiting endorsement, and no
...
| [`docs/preprint_v1_4_candidate.md`](docs/preprint_v1_4_candidate.md) | Unreviewed corrected manuscript; archived v1.3 remains separately preserved |
